# GDM - Glucose Diary Manager

Приложение для ведения дневника уровня сахара в крови для людей с сахарным диабетом.

## 🎯 Описание

GDM (Glucose Diary Manager) - это iOS приложение, разработанное для помощи людям с сахарным диабетом в ведении точного дневника уровня сахара в крови. Приложение позволяет отслеживать:
...
### Приоритеты развития
1. **Критические**: Постоянное хранение данных, редактирование записей
2. **Важные**: Поиск и фильтрация, улучшение PDF
3. **Желательные**: Статистика, анимации, темная тема
...
**Важно**: Это приложение предназначено для информационных целей и не заменяет профессиональную медицинскую консультацию. Всегда консультируйтесь с врачом по вопросам лечения диабета. 