...
- ⚠️ **Нет постоянного хранения**: нужно UserDefaults/CoreData
- ⚠️ **Нет синхронизации**: нет облачного хранения
...
- 🐛 **Локализация**: не все элементы переведены
